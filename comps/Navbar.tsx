...
const Navbar = () => {
    ...
    return(
        <>
            <div className={navBar ? "z-50 sticky top-0 py-3.5 flex items-center shadow justify-center gap-20 text-slate-400 bg-gradient-to-r from-background-100 via-background-200 to-background-100":"z-50 sticky top-0 py-3.5 flex items-center shadow justify-center gap-20 text-slate-400 bg-background-100"}>
